...
import PapyrusSedge from '../lib/papyrus-sedge';
...
describe('PapyrusSedge', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('papyrus-sedge');
  });

  describe('when the papyrus-sedge:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.papyrus-sedge')).not.toExist();
